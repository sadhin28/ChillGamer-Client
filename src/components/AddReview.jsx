    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#f4f3f0] px-4 py-8">
            <div className="w-full max-w-4xl bg-white shadow-md rounded-lg p-10 relative">
                <Link to="/" className="absolute top-4 left-4 text-lg font-semibold text-black hover:underline">
                    ← Back to home
                </Link>

                <h2 className="text-3xl font-bold text-center text-black mb-2">Add Review</h2>


                <form onSubmit={handleSubmit} className="space-y-4">
                    <label className='block mb-1 font-medium text-black'>Game Image</label>
                    <input
                        type="file"
                        name="image"
                        accept="image/*"
                    ...
                    <div>
                        {
                            data.map(data => <div key={data.name}>
                                <label className="block text-black mb-1 font-medium">{data.label}</label>
                                <input
                                    name={data.name}
                    ...
                    <div>
                          <label className="block text-black mb-1 font-medium">User Name</label>
                    <input
                        name='name'
                    ...
                    {/* user email */}
                    <div>
                          <label className="block text-black mb-1 font-medium">User Email</label>
                    <input
                        name='email'
                        type='email'
