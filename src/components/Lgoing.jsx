        ...
        <div className="flex items-center justify-center min-h-screen bg-gray-100">
            <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='mt-2 text-black hover:underline'><Link onClick={handelForgatePassword}>Forgot password?</Link></div>
                    <div className='text-center mt-2 text-black'><span>You have no Acount? </span> <Link to='/register'><span className="text-green-600 hover:underline">Register Now</span></Link></div>
